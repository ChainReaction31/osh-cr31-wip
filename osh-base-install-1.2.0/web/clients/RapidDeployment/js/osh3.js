...
OSH.UI.CesiumView = OSH.UI.View.extend({
    ...
    updateMapMarker: function (id, properties) {
        ...
        if (!isNaN(lon) && !isNaN(lat)) {
            ...
            if (isModel) {
                marker.model.scale = modelScale * 2 / 3;
                marker.model.uri.setValue(imgIcon); // Updates icon model
            }
            //---------------------------------------------------------------//
            else {
                marker.billboard.image = imgIcon; // Updates icon billboard image
            }
